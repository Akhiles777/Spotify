...
isTextDispalayed?: boolean;
isThumbDisplayed?: boolean;
}


export function ProgressBar ({currentValue, value, progress, onSeek, isTextDispalayed, isThumbDisplayed}:Props) {
    return (
     <div className="flex items-center gap-5">
        {isTextDispalayed && (   
 <span className="w-10">{transformDuration(currentValue || 0)}</span>)}
